        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
          ...
          <div className='space-y-5'>
            ...
            <div className='space-y-2'>
              <label className='black text-xs fron-semibold text-slate-700 uppercase tracking-wide'>Username</label>
            ...
            {/* {Email field} */}
            <div className='space-y-2'>
              <label className='black text-xs fron-semibold text-slate-700 uppercase tracking-wide'>Email</label>
              <div className='relative group'>
            ...
            {error && (
              <div className='rounded-lg bg-red-50 border border-red-200 p-3'>
                <p className='text-xs textred-600 font-medium text-center'>{error}</p>
              </div>
            )}
            ...
            >
              <span className='relative z-10 flex items-center justify-center gap-2'>
                {loading ? (
                  <>
                    <div className='w-4 b-4 border-2 border-white/30 border-t-white rounded-full animate-spin' />
                    Creating account...
                  </>
                ) : (
                  <>
